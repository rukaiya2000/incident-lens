...
export default function InvestigationPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <main className="mx-auto w-full max-w-7xl px-6 py-8">
    <header className="flex flex-col gap-5 border-b border-slate-200 pb-6 dark:border-zinc-800 lg:flex-row lg:items-end lg:justify-between">
      ...
      <button onClick={() => setModalOpen(true)} className="rounded-lg bg-blue-700 px-4 py-2 text-sm font-medium text-white hover:bg-blue-800">Add footage</button>
    </header>
