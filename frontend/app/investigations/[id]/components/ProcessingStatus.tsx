...
export default function ProcessingStatus({ videos }: { videos: Video[] }) {
  ...
  return (
    <div className="flex flex-col gap-4 rounded-2xl border border-white/80 bg-white/70 backdrop-blur-xl dark:border-white/5 dark:bg-zinc-950/65 p-4 shadow-sm">
