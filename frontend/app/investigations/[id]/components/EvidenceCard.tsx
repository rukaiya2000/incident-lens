...
export default function EvidenceCard({
  ...
  return (
    <button
      ...
      className="group flex w-full items-start gap-3 rounded-2xl border border-white/80 bg-white/70 backdrop-blur-xl dark:border-white/5 dark:bg-zinc-950/65 p-3 text-left transition hover:border-[var(--accent)]/50 hover:bg-[var(--accent)]/5"
    >
